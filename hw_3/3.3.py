...
class HashMixin:
    def __hash__(self) -> int:
        '''
        простой хэш, напоминающий полиномиальный хэш для строки.
        легко приводят к коллизиям из-за намеренно кривой реализации.
        кроме того, коллизии возникнут при преобразовании float -> int.
